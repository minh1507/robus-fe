...
import "./frozenFood.scss";

function FrozenFood() {
  const { t } = useTranslation();
  const navigation = useNavigate();
  useTitle(t("FrozenFood"));

  const items = [{ label: t("FrozenFood") }];
  const home = {
    icon: "pi pi-home",
    command: () => {
  ...
  const [products, setProducts] = useState([
    ...
    },
    {
      ...
      image:
        "https://afamilycdn.com/150157425591193600/2021/1/29/cac-loai-nem-cuon-dong-lanh-webuy-afamily-20210126130837-1611913134390210906801.jpg",
      weight: "100 gram",
      price: 10000,
    },
  ]);
